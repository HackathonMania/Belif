...
abstract class BaseAdapter <T> : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    protected var itemCallback: ItemCallback<T>? = null
    ...
    fun setCallback(itemCallback: ItemCallback<T>) {
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        (holder as BaseViewHolder<T>).onBind(position, data.size, data[position], itemCallback)
    }
    ...
    interface ItemCallback<T> {
        fun onAdapterClick(view: View, position: Int, item: T, bundle: Bundle)
    }
